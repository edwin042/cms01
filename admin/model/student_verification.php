<?php 
	if(isset($_GET['verifyStudent']))
	{
		...
		$sendUserData = [
			'username' => strtolower($fetchAdmissionData['date_of_birth'] . substr($fetchAdmissionData['first_name'], 0, 3)),
			'password' => password_hash($fetchAdmissionData['date_of_birth'], PASSWORD_DEFAULT),
